...
def sub_cam_eval(args, model):
    ...
    model_cam = getattr(importlib.import_module(args.clims_network), 'CAM_GCNet')(n_classes=20)
...
def run(args):
    ...
    model = getattr(importlib.import_module(args.clims_network), 'CLIMS_GCNet')(n_classes=20)
