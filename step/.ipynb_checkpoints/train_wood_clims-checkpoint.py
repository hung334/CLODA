...
def run(args):
    ...
    pth_file = 'wood_pth/res50_cam_orig.pth.pth'
    ...
    #torch.save(sample_class_mean, 'sample_class_mean_wood_org.pt')
    #torch.save(precision, 'precision_wood_org.pt')
    ...
    for ep in range(args.cam_num_epoches):
        ...
        for step, pack in enumerate(train_data_loader):
            ...
            if args.ood_coeff > 0:
                ...
                loss = F.binary_cross_entropy_with_logits(output, label) + loss_M * args.distance_lambda + loss_ood * args.ood_coeff #+ hyper[0] * L_OTM + hyper[1] * L_BTM  + hyper[3] * L_REG
            else:
